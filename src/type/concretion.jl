...
Base.isless{C<:Real,D<:Real}(a::Complex{C},b::Complex{D}) = isless(norm(a),norm(b))
Base.isless{C<:Real,D<:Real}(a::Complex{C},b::D) = isless(norm(a),norm(b))
Base.isless{C<:Real,D<:Real}(a::C,b::Complex{D}) = isless(norm(a),norm(b))
Base.isless{C<:Array,D<:Array}(a::C,b::D) = isless(norm(a),norm(b))
Base.isless{C<:Array,D<:Real}(a::C,b::D) = isless(norm(a),norm(b))
Base.isless{C<:Real,D<:Array}(a::C,b::D) = isless(norm(a),norm(b))
Base.isless{C<:Array,D<:Real}(a::C,b::Complex{D}) = isless(norm(a),norm(b))
Base.isless{C<:Real,D<:Array}(a::Complex{C},b::D) = isless(norm(a),norm(b))
